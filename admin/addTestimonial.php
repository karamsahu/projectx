        ...
        <div id="admin-content">
          ...
          <div id="panel-form">
        	...
        	<ul>
                ...
                <li><input  type="text" name="txtProblem" placeholder="Why did you joined us ?"/></li>
                <li><input type="text" name="txtSolution" placeholder="How did we helped you ?"/></li>
                <li><input type="text" name="txtMessage" placeholder="Tell us about your satisfaction."/></li>
