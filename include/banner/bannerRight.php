    ...
    <aside class="banner-right">
      <div class="box consultant">
        ...
        <div class="box member-login">          
            <h2>Member Login</h2>
            <form class="clearfix" name="member-login" action="include/banner/login1.php" id="member-login" method="post">
              <input type="text" class="textBox" name="txtemail" id="email" placeholder="Username" required="" >
