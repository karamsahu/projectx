...
<head>
    ...
    <title> : Magic Dietitian : Geetika Chopra's</title>
...
<header id="header">
    	<div class="wrapper">
            ...
            <br>
            	<a href="index.php"><img style="width:200px" src="http://www.magicdietitian.com/images/magic-dietitian-logo.jpg" alt="Magic Dietitian"></a> 
            </div>
            
            <div class="logo" role="banner">
            <br>
            	&nbsp;&nbsp;<a href="index.php"><img style="margin-left:75px;" src="http://www.magicdietitian.com/images/banner-mid-fill.jpg" alt="Magic Dietitian"></a> 
            </div>
            ...
            <div  class="header1" role="banner">
            	<hr>
                <br>
				<h2 style="color:#0C3" > <span  style="color:#39C">Call</span> 99-99-899084</h2>
...
<section id="content" role="main">
    ...
    <h2>Thankyou</h2>
   	  <article>
        <h1>Dear <?php  if(isset($_SESSION['subscriberName'])){
			echo $_SESSION['subscriberName'];
			}else{
				echo "Subscriber";
				} ?></h1>	
    	<p>&nbsp;</p>
    	<p>We have recieved your your request. In order to get free diet plan, please provide us few more details. Our diet and nutrition expert will contact you soon for more details. Do not forget to reply at dr@magicdietian.com for any queries. </p> 
        <br>
        <br>
        <p>Please visit <a href="http://www.magicdietitian.com">www.magicdietitian.com</a> regularly for our 100% working diet plans and new offers. </p>
        <br>
        <br>
        <p>We have something really awesome for your overall looks. Plesae check <a href="http://">here</a> our product range.  
        </p>
        <br>
        <br>
        ...
        Regards,</p><p><br>
        Geetika Chopra <br>
        Diet and nutrition cunsultants<br>
        www.magicdietitian.com<br>
        <img src="http://www.magicdietitian.com/images/magic-dietitian-logo.jpg" width="150" height="49">
        </p>
